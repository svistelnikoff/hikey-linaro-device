...
PRODUCT_OUT_FOLDER := out/target/product/hikey960

#TARGET_PREBUILT_KERNEL := device/linaro/hikey-kernel/Image.gz-hikey960-$(TARGET_KERNEL_USE)
TARGET_PREBUILT_KERNEL := $(PRODUCT_OUT_FOLDER)/Image.gz-hikey960-$(TARGET_KERNEL_USE)
TARGET_PREBUILT_DTB := $(PRODUCT_OUT_FOLDER)/hi3660-hikey960.dtb-$(TARGET_KERNEL_USE)
